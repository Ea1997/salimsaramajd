...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="/storage/logo/logo.png" />
    <!-- CSRF Token -->
    <meta name="csrf-token" content="{{ csrf_token() }}">

    <title>SMSEXPRESS</title>
    ...
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                ...
                <img src="/storage/logo/logo.png" style="width:130px; height:40px;"   alt="">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item">
                                <a class="nav-link" href="/post/create">Poster une annonce</a>
                            </li>
                        @guest
